...
• Produzir relatório científico com evidências do desenvolvimento.`);
    ...
    R.set("recursosSonoros", `Foram previstos sons curtos e opcionais: clique.mp3 para interação com botões, sucesso.mp3 para acertos, erro.mp3 para correções, vitoria.mp3 para conclusão da atividade e ambiente.mp3 como trilha opcional.`);
